...
public class BasmaOnlineStoreProductApplication {
	...
	{
		return args->{
			Categorie category = cr.save(new Categorie( "Cosmetique", "img", new ArrayList<Produit>()));
			ArrayList<String> listImage = new ArrayList<String>();
			listImage.add("img1");
			listImage.add("img2");
			listImage.add("img3");
			listImage.add("img4");
		pr.save(new Produit(null, "dentifrice", Math.random()*100, 20, listImage, category));
